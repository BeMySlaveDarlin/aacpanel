...
export const Icon = {
    ...
    // Where a session lives: on the stream or in the console of the host.
    pin: () => html`<svg ...${stroke}><path d="M12 21s-6.5-5.4-6.5-11a6.5 6.5 0 0 1 13 0c0 5.6-6.5 11-6.5 11Z" /><circle cx="12" cy="10" r="2.3" /></svg>`,
